...
def start_v2():
	request.urlretrieve(r"http://60.205.221.103/zzz/v2ray/v2_config_1.json", r"C:\pythonz5\sun36x64\v2ray\config.json")
	os.system(r'C:\pythonz5\sun36x64\v2ray\v2ray.exe')
...
def get_v2_json():
	...
	lj = os.path.join(gzlj, "config.json")
...
def v2ray_key_rm():
#用于删除用户key的函数
	os.remove(r'C:\pythonz5\unsers\key.json')
