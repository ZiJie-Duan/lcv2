...
#更新验证文件位置
up_json_lj = r"C:\pythonz3\unsers\update.json"
#更新插件位置
up_exe_lj = os.path.join(gzlj, "更新v2ray.exe")

#创建的根目录
mblj_1 = r'C:\pythonz3\sun36x64'
mblj_2 = r'C:\pythonz3\unsers'

#v2ray本体路径
v2ray_start_lj = r'C:\pythonz3\sun36x64\v2ray\v2ray.exe'
#v2ray json文件服务器位置
v2ray_server_json_lj = "http://lucyx.cn/zzz/v2ray/v2_config_1.json"
#v2ray 本地json文件位置
v2ray_json_lj = r"C:\pythonz3\sun36x64\v2ray\config.json"

#key json本地位置
user_json_lj = r'C:\pythonz\unsers\user.json'

#v2ray服务器压缩包
v2ray_server_rar_lj = "http://60.205.221.103/v2ray/v2rayWin.zip"

#v2ray本地压缩包
v2ray_rar_lj = r"C:\pythonz\sun36x64\V.zip"
