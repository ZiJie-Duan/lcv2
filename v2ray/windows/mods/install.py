...
def install_v2():
	#用于安装v2本体的函数
	#需要创建的路径
	mblj_1 = r'C:\pythonz5.1\sun36x64'
	mblj_2 = r'C:\pythonz5.1\unsers'

	#创建路径
	os.makedirs(mblj_1)
	os.makedirs(mblj_2)

	input("正在准备下载 按下回车后继续！")
	#v2ray服务器压缩包
	v2ray_server_rar_lj = "http://60.205.221.103/v2ray/v2rayWin.zip"
	#v2ray本地压缩包
	v2ray_rar_lj = r"C:\pythonz5.1\sun36x64\V.zip"
	v2ray_rar_jy_lj = r"C:\pythonz5.1\sun36x64"
	print("正在下载V2ray资源包\n")
	print("这需要几分钟时间\n")
